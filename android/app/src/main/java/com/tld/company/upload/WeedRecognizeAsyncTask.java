...
public class WeedRecognizeAsyncTask extends AsyncTask<Void, Void, ResponseData> {
    ...
    protected WeedRecognizeAsyncTask(String imag_baseb64) {
    ...
    protected ResponseData doInBackground(Void... params) {
        ResponseData responseData =AliyunPlantApiService.weed(imag_baseb64);
